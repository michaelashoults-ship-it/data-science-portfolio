...
- Higher risk allocations lead to higher expected returns
- Diversification reduces portfolio risk
- Solver identified an optimal risky portfolio dominated by risk-adjusted performance
...
- Excel Solver
- Google Finance
- Financial formulas (returns, covariance, correlation)
