...
- Constructed Capital Market Line portfolios combining risky and risk-free assets
- Tools: Excel, financial modeling, data from Google Finance
...
- Optimization (Excel Solver, portfolio allocation)
...
- Dimensionality reduction and data geometry
...
- R / RMarkdown
- Excel (Solver, financial modeling)
- POT (Python Optimal Transport)
- Google Finance / Open datasets

---

## Purpose

This portfolio demonstrates applied data science skills across statistics, machine learning, and computational modeling. Each project focuses on translating mathematical ideas into computational implementations and interpreting results in a meaningful way.
